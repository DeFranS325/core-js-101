...
function logger(func, logFunc) {
  return (...param) => {
    ...
    const paramStr = JSON.stringify(param).slice(1, -1);
    const logStart = `${funcName}(${paramStr}) starts`;
    const logEnd = `${funcName}(${paramStr}) ends`;
